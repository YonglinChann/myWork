...
SWIFT_PROTOCOL("_TtP19DCloudUniappRuntime14UniFormControl_")
@protocol UniFormControl <JSExport>
...
@protocol UniInputElement <UniElement, UniFormControl>
/// <ul>
///   <li>
...
@protocol UniTextareaElement <UniElement, UniFormControl>
/// <ul>
///   <li>
///     表单的控件名称，作为键值对的一部分与表单(form组件)一同提交
///   </li>
